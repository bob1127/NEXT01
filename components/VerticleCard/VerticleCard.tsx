...
import { MusicVisual, OtherVisual, TodoVisual } from "./visual";
        ...
        <div className="mx-auto max-w-6xl px-4">
            ...
            <div ref={scope}>
                ...
                <button
                    ...
                    className="mt-40 back-to-site-btn fixed bottom-6 left-1/2 z-10 -translate-x-1/2 translate-y-[300%] rounded-full bg-black px-4 py-2 text-white opacity-0 shadow-lg"
                >
                    Back to site
                </button>
